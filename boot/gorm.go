...
import (
	"database/sql"
	extra "noticeservices/app/model/extra"
	system "noticeservices/app/model/system"
	"noticeservices/boot/internal"
	"noticeservices/library/config"
	"noticeservices/library/global"
...
var Postgresql = new(_postgresql)
...
func (m *_postgresql) Initialize() {
	if m.db, m.err = gorm.Open(postgresql.New(postgresql.Config{
		DSN:                       global.Config.Postgresql.Dsn(), // DSN data source name
...
func (m *_postgresql) AutoMigrateTables() {
